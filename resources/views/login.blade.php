    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar-main">
                <form role="form" method="POST" class="navbar-form navbar-right" action="{{ url('/main') }}">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <div class=" navbar-left help-block with-errors"></div>
                        ...
                        @endif
                        <input type="email" class="form-control" placeholder="Email" name="email" data-error="Oops! Looks like your email is invalid &#10148; &nbsp;" value="{{ old('email') }}" required autofocus>&nbsp;
                        <input type="password" class="form-control" placeholder="Password" name="password" required>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="remember"><span class="white-text"> Remember Me</span>
                                <br /><a class="white-text" href="{{ url('/password/reset') }}">Forgot password?</a>
                            </label>
                        </div>
                    </div>
