...
<!-- Sets dashboard element active -->
@section('list-item-1')
    <li class="active"><a href="postjob/EPId={{Auth::user()->id}}">Post a Job</a></li>
@endsection
        ...
        <div class=" panel panel-default container-fluid">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="loaction" name="location" placeholder="Job Location" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="role" name="role" placeholder="Short Description about job" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="industry" name="industry" placeholder="Company Industry">
                ...
                <div class="form-group">
                    <label for="role" class="col-sm-2 control-label">Employment Status</label>
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <input type="radio" name="stat" value="Part time">Part time
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="stat" value="Full time">Full time
                        </label>
                    </div>
                </div>

                <div class="form-group">
                    <label for="skills" class="col-sm-2 control-label">Employment Type</label>
                    <div class="col-sm-10">
                        <label class="radio-inline">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="type" value="Contractor">Contractor
                        </label>

                        <label class="radio-inline">
                            <input type="radio" name="type">Temporary Employee
                        </label>
                    </div>
                </div>
                <hr>
        ...
        <div class="panel panel-default container-fluid">
            ...
            <div class="panel-body">
                <h4>Experiance</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="city" name="Years" placeholder="Years">
                ...
                <h4>Education</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="Degree" name="Degree" placeholder="Company Industry">
         ...
         <div class="form-group pull-right">
             <div class="col-sm-offset-2 col-sm-10 ">
                 <button type="submit" class="btn btn-info">Post job</button>
             </div>
         </div>
     </form>
        </div>
